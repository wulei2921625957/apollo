...
function cluster_create() {
    ...
    openapi_post "openapi/v1/envs/${env}/apps/${appId}/clusters" "$(
        cat <<BODY
{
    "name":"${clusterName}",
    "appId":"${appId}",
...
function namespace_create() {
    ...
    openapi_post "openapi/v1/apps/${appId}/appnamespaces" "$(
        cat <<BODY
{
  "name": "${name}",
  "appId": "${appId}",
...
function namespace_release() {
    ...
    openapi_post "openapi/v1/envs/${env}/apps/${appId}/clusters/${clusterName}/namespaces/${namespaceName}/releases" "$(
        cat <<BODY
{
...
function item_create() {
    ...
    openapi_post "openapi/v1/envs/${env}/apps/${appId}/clusters/${clusterName}/namespaces/${namespaceName}/items" "$(
        cat <<BODY
{
    "key":"${key}",
    "value":"${value}",
...
function item_update() {
    ...
    openapi_put "openapi/v1/envs/${env}/apps/${appId}/clusters/${clusterName}/namespaces/${namespaceName}/items/${key}" "$(
        cat <<BODY
{
  "key":"${key}",
  "value":"${value}",
...
function item_update_create_if_not_exists() {
    ...
    openapi_put "openapi/v1/envs/${env}/apps/${appId}/clusters/${clusterName}/namespaces/${namespaceName}/items/${key}?createIfNotExists=true" "$(
        cat <<BODY
{
  "key":"${key}",
  "value":"${value}",

...
public class DefaultDiscoveryService implements DiscoveryService {
    ...
    public List<ServiceDTO> getServiceInstances(String serviceId) {
        ...
        return application.getInstances().stream().map(INSTANCE_INFO_SERVICE_DTO_FUNCTION)
                .collect(Collectors.toList());
    }

    private static final Function<InstanceInfo, ServiceDTO> INSTANCE_INFO_SERVICE_DTO_FUNCTION = instance -> {
